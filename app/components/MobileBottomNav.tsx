...
const iconPath=(themeId:string,name:string)=>{
  ...
  if(themeId==='pip-boy'){
    const pipboyKey=name==='dms'?'dms':name==='create_post'?'post':'settings';
    return `/pipboy/nav-${pipboyKey}-v8.png`;
  }
